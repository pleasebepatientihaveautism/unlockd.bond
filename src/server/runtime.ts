  ...
  const payment =
    config.mode === "demo"
      ...
      : new HederaPaymentProvider({
          ...
          collateralTokenId:
            config.HEDERA_COLLATERAL_TOKEN_ID ??
            liveValue(config.HEDERA_TOKEN_ID, "HEDERA_TOKEN_ID"),
          escrowId:
            config.HEDERA_ESCROW_ID ?? liveValue(config.HEDERA_OPERATOR_ID, "HEDERA_OPERATOR_ID"),
          escrowKey:
            config.HEDERA_ESCROW_KEY ??
            liveValue(config.HEDERA_OPERATOR_KEY, "HEDERA_OPERATOR_KEY"),
